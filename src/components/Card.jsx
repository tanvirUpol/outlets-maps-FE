...
const Card = ({title,mainData,diff,percentage}) => {
    const numFor = Intl.NumberFormat('en-US');

    return (
        <>
            <Link href="#" className="block mx-1 w-full p-5 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100">
